...
- **T012** `src/web/App.tsx` + `index.html`: port the capture prototype (pipeline board, Lead/Viewing/Offer sheets, mandatory next-action, interest→temperature, offer auto-counter). Wire to API endpoints. Greek UI strings. Served by `bun run dev`.
...
## Dependency notes
- T004–T006 parallel after T001. T007 needs T002/T003. T009 needs T007. T012 needs T009. Phase 2 needs Phase 1 board + queries. T018/T019 parallel after T017.
